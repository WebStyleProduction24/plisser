  ...
  <div id="feedback">
    ...
    <div class="curtain-care-info flex">
      ...
      <div class="curtain-care-info-txt p-8">
        <div class="p-8 cont">
          <p class="p-t-b-23">Уберите мусор из нижней направляющей</p>
          <p class="p-t-b-23">Раскройте полотно москитной сетки плиссе</p>
          <p class="p-t-b-23">Очистите полотно москитной сетки с помощью пылесоса, используя насадку с щеткой</p>
          <p class="p-t-b-23">При необходимости используйте влажную губку или баллон с сжатым воздухом</p>
          <p class="p-t-b-23">Смажьте направляющие силиконовой смазкой</p>
        </div>
      </div>
    </div>
  </div>
