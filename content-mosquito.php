  ...
  <div class="curtains-direction-text shadow border-c p-24">
    ...
    <div>
      <div class="txt-grey">
        ...
        <p class="weight">Взять наименьший размер из полученных.</p> 
        <p>3. Необходимо добавить к размерам ширины и высоты с каждой стороны по 25 мм (Система Slim) или по 40 мм (Система Smart).</p>
        <p>4. Если необходимо раму опустить максимально вниз (на пол), то нужно замерить размер от светового проёма до пола и добавить полученный результат к размеру высоты.</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="curtains-direction-text shadow border-c p-24">
    ...
    <div>
      <div class="txt-grey txt">
        <p>1. Готовую москитную систему совместить с изделием или проёмом, на который планируется установка.</p>
        <p>2. Выставить москитную систему по уровню.</p>
        <p>3. Зафиксировать, а затем закрутить саморезы в специальные отверстия по 4-м углам москитной системы.</p>
      </div>
    </div>
  </div>
...
<div id="curtain-care" class="block">
  ...
  <div class="curtain-care-info flex">
    ...
    <div class="curtain-care-info-txt p-8">
      <div class="p-8 cont">
        <p>1.Уберите мусор из нижней направляющей.</p>
        <p>2.Раскройте полотно москитной сетки плиссе.</p>
        <p>3.Очистите полотно москитной сетки с помощью пылесоса, используя насадку с щеткой.</p>
        <p>4.При необходимости используйте влажную губку или баллон с сжатым воздухом.</p>
        <p>5.Смажьте направляющие силиконовой смазкой.</p>
      </div>
    </div>
  </div>
</div>