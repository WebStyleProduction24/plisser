<?php
/*
Template Name: Шаблон страницы Шторы в рамке
*/
?>
...
<main class="p-t-30 framed-curtains">
  ...
  <div id="main-block" class="block flex p-b curtains-main framed-curtains-b">
    <div class="curtains-home shadow flex ">
      ...
      <img class="photo-min" src="<?php echo get_bloginfo('template_url'); ?>/img/products-main/shtori-v-ramke.png";>
    </div>
  ...
  <div id="projects" class="block">
    ...
    <div class="slick-button">
        <button type="button" class="control-prev-s-1" id="control-prev-s-1"></button>
        <button type="button" class="control-next-s-1" id="control-next-s-1"></button>
      </div>
  </div>
