  ...
  <div class="curtains-direction-text shadow border-c p-24">
    ...
    <div>
      <div class="txt-grey">
        ...
        <p class="weight">Взять наименьший размер из полученных.</p>
        <p>3. Необходимо добавить к размерам ширины и высоты с каждой стороны по 25 мм (Высота рамы системы Slim)</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="curtains-direction-text shadow border-c p-24">
    ...
    <div>
      <div class="txt-grey txt">
        <p>1. Штору в рамке совместить с проёмом, на который планируется установка.</p>
        <p>2. Выставить по уровню и зафиксировать, закрутив саморезы в отверстия по 4-м углам рамы.</p>
      </div>
    </div>
  </div>
  ...
  <div class="curtain-care-info flex">
    ...
    <div class="curtain-care-info-txt p-8">
      <div class="p-8 cont">
        ...
        <p>2. Раскройте полотно шторы и очистите его с помощью пылесоса, используя насадку с мягкой щеткой.</p>
        <p>3. При необходимости используйте влажную губку или баллон с сжатым воздухом.</p>
      </div>
    </div>
  </div>
</div>